  ...
  return createServerFnStaticCache({
    getItem: async (ctx) => {
      if (typeof document === "undefined") {
        ...
        const publicUrl = "C:/Users/Ana/Desktop/landing/intent-landing/dist";
        const {
          promises: fs
...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-BMtNmYop.mjs');
    case VIRTUAL_MODULES.serverFnManifest:
      return await import('./_tanstack-start-server-fn-manifest_v-BNZlcS1Z.mjs');
    default:
...
const appCss = "/assets/app-BsHPvZWw.css";
...
const $$splitComponentImporter$1 = () => import('./privacy-xVluEZw9.mjs');
...
const $$splitComponentImporter = () => import('./index-8UMMSu9F.mjs');
...
export { createServerFn as c, serverEntry as default };
